...
// USERS
 User greg = User(id: 1, name: 'Greg', imageUrl: 'assets/images/greg.jpg');
 User james =
    User(id: 2, name: 'James', imageUrl: 'assets/images/james.jpg');
 User john = User(id: 3, name: 'John', imageUrl: 'assets/images/john.jpg');
 User olivia =
    User(id: 4, name: 'Olivia', imageUrl: 'assets/images/olivia.jpg');
 User sam = User(id: 5, name: 'Sam', imageUrl: 'assets/images/sam.jpg');
 User sophia =
